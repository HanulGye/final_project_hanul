	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label for="formGroupExampleInput3">대표 이미지 설정</label> <input
						type="file" class="form-control" id="formGroupExampleInput3"
						placeholder="상품 리스트 페이지에 노출되는 이미지 영역입니다." name="">
				</div>
				<div class="form-group">
					<label for="formGroupExampleInput4">설명 이미지 설정</label> <input
						type="file" class="form-control" id="formGroupExampleInput4"
						placeholder="개별 상품 페이지에 노출되는 이미지 영역입니다." name="">
				</div>
				<div class="form-group">
