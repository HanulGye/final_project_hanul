...
public class ProductService {
	...
	public ModelAndView insert(ProductDTO productDTO, HttpSession session, MultipartFile mainImage,
	...
	public ModelAndView selectOne(ProductDTO productDTO) throws Exception {
		...
		if (product != null) {
			...
			for (int i = 0; i < product.size(); i++) {
				product.get(i).setMainImg(image.get(i));
				product.get(i).setSelOption(option.get(i));
